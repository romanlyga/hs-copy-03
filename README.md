...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://stg-api.stackbit.com/pull/5fc5fc0aa8863c001d2f5530
...
To start editing your site, you can use the Sanity interface at https://hs-5fc0a.sanity.studio/.
...
Generated at `2020-12-01T08:17:33.743Z` by Stackbit version `0.3.38`.